<script lang="ts">
  ...
  import { dataSources, isLoading, errorMessage } from '../stores';
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
  <section>
    ...
    <p class="text-xl text-gray-600 mb-6">Browse available data source plugins</p>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div class="px-4 py-4">
                <div>
                  ...
                  {:else}
                    <p class="text-gray-500">Plugin ID: {id}</p>
                  {/if}
                </div>
              </div>
              <div class="px-4 py-3 bg-gray-50 border-t border-gray-200">
                <a href="/workflow" class="flex items-center justify-center text-blue-600 hover:text-blue-800" aria-label="Use this data source">
