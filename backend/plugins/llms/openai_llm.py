...
class OpenAILLMConfig(LLMConfig):
    ...
    """
    provider: str = "openai"
    base_url: str = "https://api.openai.com/v1"  # Can be changed for custom API endpoints
...
class OpenAILLMProvider(LLMProvider):
    """
    An LLM provider that uses OpenAI API or compatible endpoints.
    """
    plugin_id = "openai_llm"
    ...
    def __init__(self, config: OpenAILLMConfig):
        ...
        Args:
            config: Configuration for the OpenAI LLM provider
        """
        self.config = config
    ...
    async def generate_batch(self, prompts: List[str], **kwargs) -> List[LLMResponse]:
        """
        Generate text for multiple prompts using the OpenAI API.
        ...
        return {
            ...
            "properties": {
                ...
                "base_url": {
                    "type": "string",
                    "title": "Base URL",
                    "description": "Base URL for the OpenAI API or compatible endpoint",
